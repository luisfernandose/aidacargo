...
namespace BufaloCargo.Areas.Identity.Pages.Account
{
    ...
    public class LoginModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            var rol = db.Roles.Where(u => u.Name == Roles.SuperAdmin.ToString()).FirstOrDefault();
            if (rol != null)
            {
                var userRol = db.UserRoles.Where(h => h.RoleId == rol.Id).FirstOrDefault();
                ViewData["Validate"] = userRol != null;
            }
            else
